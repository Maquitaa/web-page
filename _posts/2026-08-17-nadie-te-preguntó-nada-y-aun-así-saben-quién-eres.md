...
Nunca dieron el nombre. No hizo falta: a la tercera frase tú ya sabías exactamente de quién hablaba.

Guárdate esa escena, porque es toda la ley en miniatura.
...
En cualquier trabajo existe un archivo con el RUT, la dirección y el horario de cada persona. Vive en un Drive compartido con más gente de la que uno imagina. No me extrañaría que en tu empresa exista uno o varios similares
...
Y el riesgo no es el hacker de película, encapuchado frente a seis pantallas. He visto el riesgo de verdad, y es mucho más aburrido: que el link del Drive esté en “cualquiera con el enlace puede ver”, y que lo vea quien no debe. Un ex trabajador que todavía tiene acceso. Un proveedor al que le compartieron la carpeta entera para pasarle un archivo.
...
Sigamos en el mall. Junto a las cámaras y las patentes, existen los reportes internos de accidentes: alguien se resbaló en el nivel dos, se golpeó con una puerta, se cayó de la escalera. Y en esos reportes a veces aparece el nombre completo de la persona accidentada. A veces, el de un niño.

Ese detalle cambia la categoría del problema. Pero la historia que de verdad me explicó la categoría no pasó en un mall. Pasó después de unos tornados, cuando trabajaba para un banco gringo.
...
Así que dimos vuelta el análisis: en vez de decidir a quién ofrecerle qué, estimamos cuánto se iba a recuperar en plata. Mismo problema, resuelto sin pisar el palito.

De esa experiencia me quedó grabado el punto clave: los datos sensibles no son peligrosos solo cuando alguien quiere hacerte daño. Son datos con los que se puede discriminar incluso queriendo ayudar. Esa es la vara con que la ley los mide.

La lista es esta: datos de salud, datos biométricos, origen étnico, opiniones políticas o sindicales, convicciones religiosas o filosóficas, vida sexual, orientación sexual o identidad de género. Y situación socioeconómica, que la 21.719 suma por cuenta propia, el GDPR europeo no la incluye. Mírala de nuevo y nota el patrón: ninguno de esos datos sirve para “encontrarte”. Son de otra especie. Y el daño también.
...
¿Y? El perfil es público, dirá más de uno. Cualquiera puede verlo.
